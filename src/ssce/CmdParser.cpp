...
#include <stdint.h>
/*
 * Converted to C++ from https://github.com/Sima214/SS-CE/blob/master/src/cmdparser/CmdParser.c
 */
#define strequal(s1, s2) !std::strcmp(s1, s2)
